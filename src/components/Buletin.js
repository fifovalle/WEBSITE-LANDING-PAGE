...
const Buletin = () => {
  return (
    <div className="max-w-[1520px] mx-auto text-white px-4 bg-[#000000]">
      <div className="mx-auto grid lg:grid-cols-3">
        ...
        <div className="my-4">
          <div className="flex flex-col sm:flex-row items-center justify-between w-full">
            ...
            />
            <button className="bg-green-500 text-white rounded-md font-medium w-[240px] h-[50px] ml-4 my-6 px-6 border-none">
              Beritahu Kami
            </button>
          </div>
          <p>
